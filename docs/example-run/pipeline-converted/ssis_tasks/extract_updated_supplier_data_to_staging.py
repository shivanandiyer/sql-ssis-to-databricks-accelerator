# Converted from SSIS Data Flow Task: Extract Updated Supplier Data to Staging
...
def run(entity: str, last_cutoff: str, new_cutoff: str, environment: str, catalog: str) -> None:
    ...
    Original destination table: Integration.Supplier_Staging
    ...
    df = (
        ...
        .option("query", 'EXEC Integration.GetSupplierUpdates ?, ?\nWITH RESULT SETS\n(\n    (\n        [WWI Supplier ID] int,\n        Supplier nvarchar(100),\n        Category nvarchar(50),\n        [Primary Contact] nvarchar(50),\n        [Supplier Reference] nvarchar(20),\n        [Payment Days] int,\n        [Postal Code] nvarchar(10),\n        [Valid From] datetime2(7),\n        [Valid To] datetime2(7)\n    )\n);' if False else "<TODO: parameterise with last_cutoff/new_cutoff>")
        .load()
    )
    target_fqn = f"{catalog}.bronze.integration_supplier_staging"
