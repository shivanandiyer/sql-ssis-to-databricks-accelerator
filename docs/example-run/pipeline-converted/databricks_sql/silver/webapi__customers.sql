-- Source: OLTP:WebApi.Customers  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Views/Customers.sql)
...
CREATE OR REPLACE VIEW wwi_<env>.silver.webapi__customers AS
SELECT c.CustomerID,
       c.CustomerName,
