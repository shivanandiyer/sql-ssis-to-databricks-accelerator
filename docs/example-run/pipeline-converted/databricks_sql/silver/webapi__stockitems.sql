-- Source: OLTP:WebApi.StockItems  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Views/StockItems.sql)
...
CREATE OR REPLACE VIEW wwi_<env>.silver.webapi__stockitems AS
