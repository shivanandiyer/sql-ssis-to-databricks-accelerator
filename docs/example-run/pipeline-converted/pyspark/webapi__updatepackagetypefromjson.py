# Source: OLTP:WebApi.UpdatePackageTypeFromJson  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Stored Procedures/UpdatePackageTypeFromJson.sql)
...
def updatepackagetypefromjson(*args, **kwargs) -> None:
