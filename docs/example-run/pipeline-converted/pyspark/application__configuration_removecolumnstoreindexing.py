# Source: OLTP:Application.Configuration_RemoveColumnstoreIndexing  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/Application/Stored Procedures/Configuration_RemoveColumnstoreIndexing.sql)
...
def configuration_removecolumnstoreindexing(*args, **kwargs) -> None:
