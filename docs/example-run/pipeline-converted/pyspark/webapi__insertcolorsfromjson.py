# Source: OLTP:WebApi.InsertColorsFromJson  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Stored Procedures/InsertColorsFromJson.sql)
...
def insertcolorsfromjson(*args, **kwargs) -> None:
