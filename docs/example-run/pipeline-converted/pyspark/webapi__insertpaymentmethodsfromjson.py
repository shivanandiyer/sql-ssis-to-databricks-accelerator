# Source: OLTP:WebApi.InsertPaymentMethodsFromJson  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Stored Procedures/InsertPaymentMethodsFromJson.sql)
...
def insertpaymentmethodsfromjson(*args, **kwargs) -> None:
