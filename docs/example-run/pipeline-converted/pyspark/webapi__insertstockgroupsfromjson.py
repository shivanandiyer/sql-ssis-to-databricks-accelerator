# Source: OLTP:WebApi.InsertStockGroupsFromJson  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Stored Procedures/InsertStockGroupsFromJson.sql)
...
def insertstockgroupsfromjson(*args, **kwargs) -> None:
