# Source: OLTP:WebApi.InsertSuppliersFromJson  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Stored Procedures/InsertSuppliersFromJson.sql)
...
def insertsuppliersfromjson(*args, **kwargs) -> None:
