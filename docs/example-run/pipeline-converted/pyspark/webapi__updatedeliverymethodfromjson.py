# Source: OLTP:WebApi.UpdateDeliveryMethodFromJson  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Stored Procedures/UpdateDeliveryMethodFromJson.sql)
...
def updatedeliverymethodfromjson(*args, **kwargs) -> None:
