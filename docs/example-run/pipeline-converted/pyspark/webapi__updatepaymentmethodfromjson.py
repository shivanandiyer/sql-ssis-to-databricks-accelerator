# Source: OLTP:WebApi.UpdatePaymentMethodFromJson  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Stored Procedures/UpdatePaymentMethodFromJson.sql)
...
def updatepaymentmethodfromjson(*args, **kwargs) -> None:
