# Source: OLTP:WebApi.UpdateSupplierCategoryFromJson  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Stored Procedures/UpdateSupplierCategoryFromJson.sql)
...
def updatesuppliercategoryfromjson(*args, **kwargs) -> None:
