# Source: OLTP:WebApi.UpdateSupplierFromJson  (/Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/WebApi/Stored Procedures/UpdateSupplierFromJson.sql)
...
def updatesupplierfromjson(*args, **kwargs) -> None:
