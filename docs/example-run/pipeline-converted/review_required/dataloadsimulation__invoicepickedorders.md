# Review Required: OLTP:DataLoadSimulation.InvoicePickedOrders

- **Object type:** PROCEDURE
- **Source file:** /Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/DataLoadSimulation/Stored Procedures/InvoicePickedOrders.sql
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN -- need to reorder undersupplied items
            ...
            INSERT Sales.Orders
                (OrderID, CustomerID, SalespersonPersonID, PickedByPersonID, Co
```