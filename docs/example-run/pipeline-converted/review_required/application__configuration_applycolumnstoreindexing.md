# Review Required: OLTP:Application.Configuration_ApplyColumnstoreIndexing

- **Object type:** PROCEDURE
- **Source file:** /Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/Application/Stored Procedures/Configuration_ApplyColumnstoreIndexing.sql
...
REORGANIZE WITH (COMPRESS_ALL_ROW_GROUPS = ON);';
        ...
        END TRY
        BEGIN CATCH
            PRINT N'Unable to apply columnstore
```