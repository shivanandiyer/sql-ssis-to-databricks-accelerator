# Review Required: OLTP:Application.Logs

- **Object type:** TABLE
- **Source file:** /Users/shivaiyer/Documents/Claude/sql-server-samples/samples/databases/wide-world-importers/wwi-ssdt/wwi-ssdt/Application/Tables/Logs.sql
- **Classification:** PARTIAL_AUTOMATION

## Why this needs manual review

- Column `INDEX` (CCX_Application_Logs -> STRING): Unrecognised SQL Server type 'CCX_Application_Logs' — defaulted to STRING. MANUAL REVIEW REQUIRED.
